...
define config.name = _("По ком мерцает светодиод")
...
define build.name = "По_ком_мерцает_светодиод"
...
define config.main_menu_music = "main_menu-snowfall.mp3"
...
define config.save_directory = "November-1699809557"
